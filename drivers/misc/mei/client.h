...
struct mei_me_client *mei_me_cl_by_uuid_id(struct mei_device *dev,
					   const uuid_t *uuid, u8 client_id);
void mei_me_cl_rm_by_uuid(struct mei_device *dev, const uuid_t *uuid);
void mei_me_cl_rm_by_uuid_id(struct mei_device *dev,
			     const uuid_t *uuid, u8 id);
 ...
 */
static inline const uuid_t *mei_me_cl_uuid(const struct mei_me_client *me_cl)
{
 ...
 */
static inline const uuid_t *mei_cl_uuid(const struct mei_cl *cl)
{
