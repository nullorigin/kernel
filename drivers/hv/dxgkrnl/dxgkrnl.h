...
struct dxgsharedsyncobject *
dxgsharedsyncobj_create(struct dxgadapter *adapter,
...
int dxgvmb_send_signal_sync_object(
	...
	struct d3dkmthandle *object, u32 context_count,
	struct d3dkmthandle *contexts, u32 fence_count, u64 *fences,
	struct eventfd_ctx *cpu_event, struct d3dkmthandle device);
...
#define DXG_TRACE_IOCTL_END(ret)                              \
	do {                                                  \
		if (ret < 0)                                  \
